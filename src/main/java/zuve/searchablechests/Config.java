...
final class Config {
	...
	Config(final ForgeConfigSpec.Builder builder) {
		...
		autoSelect = builder.comment("Whether the contents of the search bar will be selected when it is focused").translation("searchablechests.config.autoSelect").define("autoSelect", true);
